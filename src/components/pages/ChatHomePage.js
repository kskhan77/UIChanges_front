...
const ChatHomePage = (props) => {
  ...
  return (
    <section>
      <div class='container-fluid' style={{ paddingTop: '7vh' }}>
        <div class='row'>
          <div class='col chatbody'>
            <div id='frame'>
              <div id='sidepanel'>
                <div id='profile'>
                  <div class='wrap'>
                      ...
                      return (
                        ...
                        >
                          <div class='wrap'>
                            ...
                            <div class='meta'>
                              <p class='name mt-2 ml-2 mb-1'>
                                {capitalize(firstname) +
                                  ' ' +
                                  capitalize(lastname)}
                              </p>
                              {/* <p class="preview text-muted">Click to view chat</p> */}
                            </div>
                          </div>
                        </li>
                      );
              ...
              {chatWith === undefined ? (
                <div class='content'>
                  <h2
                    class='display-4 pt-5 text-center text-secondary'
                    style={{ fontSize: '2rem' }}
                  >
                ...
                <div class='content'>
                  ...
                  <div class='message-input' style={{ marginLeft: '4px' }}>
                    <div class='wrap'>
                      <input
                        ref={messageRef}
                        type='text'
